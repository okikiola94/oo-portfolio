...
export default function Parent() {
  ...
  useEffect(() => {
    window.addEventListener("scroll", () => {
      ...
      const homeBottom =
        homeRef.current.offsetTop + homeRef.current.clientHeight;
      //about
      ...
      const portfolioBottom =
        portfolioRef.current.offsetTop + portfolioRef.current.clientHeight;
      //contact
      const contactTop = contactRef.current.offsetTop;
      const contactBottom =
        contactRef.current.offsetTop + contactRef.current.clientHeight;
