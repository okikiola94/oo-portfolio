...
const Socials=()=>{
    ...
    <ul className='contact-icons-link-dark__'>
      <li>  <a href="mailto:farominiyiopeyemi@gmail.com"><img src={`${process.env.PUBLIC_URL}/assets/images/aqua-email.png`} width='25px' height={'20px'} alt="email" /></a></li>
      <li><a href='https://www.linkedin.com/in/farominiyi-opeyemi-okikiola-99617b163/?originalSubdomain=ng'><img src={`${process.env.PUBLIC_URL}/assets/images/aqua-linkedin.png`} width='30px' height={'20px'} alt="linkedin" /></a></li>
      <li><a href='https://github.com/okikiola94'><img src={`${process.env.PUBLIC_URL}/assets/images/aqua-github.png`} width='30px' height={'20px'} alt="github" /></a></li>
      <li><a href='https://twitter.com/okikiola_eniola'><img src={`${process.env.PUBLIC_URL}/assets/images/aqua-twitter.png`} width='25px' height={'20px'} alt="twitter" /></a></li>
      <li> <a href='https://www.instagram.com/okikiolaannie/?hl=en'><img src={`${process.env.PUBLIC_URL}/assets/images/aqua-instagram.png`} width='28px' height={'20px'} alt="instagram" /></a></li>
    </ul>
    </div>
