          ...
          <section className="qualification section">
            ...
            <div
              ...
              style={{
                ...
                transition:
                  "opacity 2s cubic-bezier(0.5, 0, 0, 1) 0s, transform 2s cubic-bezier(0.5, 0, 0, 1) 0s",
              }}
            >
              <div className="qualification__tabs">
                <div
                  className={`qualification__button button--flex ${
                    show === "education" && "qualification__active"
                  }`}
                ...
                <div
                  className={`qualification__button button--flex ${
                    show === "work" && "qualification__active"
                  }`}
                  ...
                  {show === "work" && (
                    <div className="qualification__data">
                      <div className="qualification__parent1">
                        ...
                        <span className="qualification__subtitle">
                          CrownCrystals Tech Limited
                        </span>
                        <div className="qualification__calendar">
                          {" "}
                          <i class="uil uil-calendar-alt"></i>2019 -date
                        </div>
                      </div>
                      ...
                      <div className="qualification__parent2">
                        ...
                        <div className="qualification__calendar">
                          {" "}
                          <i class="uil uil-calendar-alt"></i>2021 -date
                        </div>
                      </div>
                      ...
                      <div className="qualification__parent3">
                        ...
                        <span className="qualification__subtitle">
                          Intern at HNGi9 2022 Cohort
                        </span>
                        <div className="qualification__calendar">
                          {" "}
                          <i class="uil uil-calendar-alt"></i>October-December 2022
                        </div>
                      </div>
                    </div>
                  )}
